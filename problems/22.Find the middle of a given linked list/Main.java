...
public class Main {
	public static void main(String[] args) {
		...
		linkedList1.insertLast(3232334);
		linkedList1.insertLast(423);
...
class LinkedListsClass {
	...
	public void findMiddle(){
		...
		if(this.isEmpty()){
			...
			System.out.println("Linked list only contains 1 element");
			return;
		}else{
			int temp;
			...
			System.out.println("Middle number is :" +  current.data);
			return;
